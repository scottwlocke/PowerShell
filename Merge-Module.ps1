# Merge's multiple PS1 files into a single PSM1 file
# This greatly reduces load time of the module
# Keeping the cmdlets in individual PS1 files aids in troubleshooting
